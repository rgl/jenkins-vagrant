...
# see https://github.com/moby/moby/releases/tag/docker-v29.6.0
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v29.6.0

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '29.6.0'
